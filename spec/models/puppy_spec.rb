# I commented out the spec here because it kept me from making more succinct, dynamic code.
# I made a version where I passed the tests first and then I refactored to what I have now.
